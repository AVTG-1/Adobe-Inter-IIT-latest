...
if __name__ == "__main__":
    # Update these paths
    engine_path = "dsine_core_fp16.plan"
    test_image = "scene.jpg"
    
    # Set target size - MUST be between 256 and 448 based on your engine build:
    # --minShapes=image:1x3x256x256
    # --optShapes=image:1x3x384x384
    # --maxShapes=image:1x3x448x448
    # Recommended: Use 384 (optimal) or 256/320/384/416/448
    TARGET_SIZE = 384
    
    print("="*60)
    print("TensorRT DSINE - Surface Normal Estimation")
    print("="*60)
    print(f"Engine constraints: min=256x256, opt=384x384, max=448x448")
    print("="*60)
    
    # Test with real image
    test_with_image(engine_path, test_image, target_size=TARGET_SIZE)
    
    # Optional: Benchmark
    # benchmark(engine_path, iterations=100, target_size=TARGET_SIZE)
