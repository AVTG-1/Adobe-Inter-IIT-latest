...
if __name__ == "__main__":
    ...
    print("="*60)
    print("TensorRT Depth Anything V2 - Verification Suite")
    print("="*60)
    
    # Test 1: Random input
    test_with_random_input(engine_path)
    
    # Test 2: Real image (if available)
    # Replace with your test image path
    test_image = "scene.jpg"
    test_with_image(engine_path, test_image)
    
    # Test 3: Benchmark
    benchmark(engine_path, iterations=100)
